...
public class TestMD5Two
{
    ...
    static
    {
        ...
        {
            System.err.println(TestMD5Two.class.getName() + "初始化失败，MessageDigest不支持MD5Util。");
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        File file = new File("F:/DownLoadUtil测试prf文件_V1.prf");
        String md5 = getFileMD5String(file);

        //文件名不同，内容相同；
        File file2 = new File("F:/ASCII码转换工具V2013.exe");
        String md52 = getFileMD5String(file2);

        //文件名不同，内容不同；
        File file3 = new File("F:/aa.txt");
        String md53 = getFileMD5String(file3);

        //测试压缩包
        File fileZip = new File("F:/00000000$$00001$19700102080542.zip");
        String md5Zip = getFileMD5String(fileZip);

        //测试压缩包
        File fileZip2 = new File("F:/0001.zip");
