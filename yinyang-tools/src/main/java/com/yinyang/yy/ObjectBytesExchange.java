...
public class ObjectBytesExchange
{
  ...
  public static byte[] toByteArray(Object obj)
  {
    if (!(obj instanceof Serializable)) {
      throw new IllegalArgumentException(ObjectBytesExchange.class.getSimpleName() + " requires a Serializable payload " + "but received an object of type [" + obj.getClass().getName() + "]");
    }
