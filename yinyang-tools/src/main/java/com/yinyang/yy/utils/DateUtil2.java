...
/**
 * 日期工具类2
 * from sellerpay by baixingang
 * @Title: DateUtil2.java
 * @Package com.yinyang.yy.utils
 * @author yinyang@dhgate.com
 * @date 2016年5月14日 下午4:20:50
 * @version V1.0
 */
...
public final class DateUtil2 {
	  ...
	  public static void main(String []args){
		  System.out.println(DateUtil2.getDateYYYYMMDDHHMMSSreal(DateUtil2.Add(new Date(), 0, 0, 10, 0)));
