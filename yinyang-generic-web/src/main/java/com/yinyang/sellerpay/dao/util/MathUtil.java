...
public class MathUtil {
	...
	public static String compare(double d1, double d2) {  
		BigDecimal val1 = new BigDecimal(Double.toString(d1));
		BigDecimal val2 = new BigDecimal(Double.toString(d2));
	    String result = "";  
    ...
    /***
     * 生成一定范围内容的随机正整数,如果随机范围小于0则返回任意范围的随机数
     * */
    public static int getRandomInt(int maxInt){
    	if(maxInt < 0){
    		return (int)Math.random();
    	}
    	int result = (int)(Math.random() * maxInt);
    	return result;
    }
