...
<div class="logintop">    
    ...
    <li><input name="" type="button" class="loginbtn" value="登录"  onclick="javascript:window.location='template/main.jsp'"  /><label><input name="" type="checkbox" value="" checked="checked" />记住密码</label><label><a href="#">忘记密码？</a></label></li>
    </ul>
    ...
    <div class="loginbm">版权所有  2015  <a href="http://www.yinyang.com">yinyang.com</a>  仅供学习交流，勿用于任何商业用途</div>
