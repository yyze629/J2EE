...
<!-- 
	加载失败  <body style="background:url(images/topbg.gif) repeat-x;">
	因此通过   加载body{background:url(images/topbg.gif) repeat-x; height:75px;} 实现
-->
<style type="text/css">
	body{background:url(images/topbg.gif) repeat-x; height:75px;}
</style>
